...
public class HouseholdsEntriesIntegrationTests
{
    ...
    public async Task GetEntries_type_filters_split_by_kind()
    {
        ...
        // 4 plain expenses + the 2 former IOUs, now "Allt på en" amount-split expenses (unified-add-entry spec).
    ...
    public async Task PostEntry_rejects_the_removed_iou_type()
    {
        ...
        // "iou" was removed (unified-add-entry spec): one-owes-all is now the "Allt på en" amount split.
