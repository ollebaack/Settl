...
/// (contacts-phone-sms spec). For email invites the web page learns whether to ask for a password (no account
...
/// address and ignore it (ADR-0005: email stays the sole identity).</summary>
