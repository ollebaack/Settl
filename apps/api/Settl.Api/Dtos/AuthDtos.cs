...
/// member's single optional number (ADR-0019/0026) — it powers "Betala med Swish" today and the
...
/// (ADR-0026 — the single number that also powers Swish). <see cref="AvatarEmoji"/> null/empty
