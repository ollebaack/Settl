...
export type SwishPayDto = Schemas['SwishPayDto']
...
export type NotificationListDto = Schemas['NotificationListDto']
export type NotificationChangeDto = Schemas['NotificationChangeDto']
export type ContributionStatsDto = Schemas['ContributionStatsDto']
export type ContributionMemberDto = Schemas['ContributionMemberDto']
export type ContributionBucketDto = Schemas['ContributionBucketDto']
export type MemberContributionDto = Schemas['MemberContributionDto']
