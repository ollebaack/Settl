...
export interface paths {
    ...
    "/dev/sms-invites/latest": {
        ...
        get: operations["GetLatestDevSmsInvite"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/contacts/pending": {
        ...
        get: operations["GetPendingContactInvites"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/contacts/invites": {
        ...
        get?: never;
        put?: never;
        post: operations["CreateContactInvite"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/households/{id}/invite-contact": {
        ...
        get?: never;
        put?: never;
        post: operations["InviteContactToHousehold"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/households/{id}/invitable-contacts": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["GetInvitableContacts"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/households/{id}/removal-preview": {
        ...
        get: operations["GetHouseholdRemovalPreview"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/households/{id}/transfer-ownership": {
        ...
        get?: never;
        put?: never;
        post: operations["TransferHouseholdOwnership"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/households/{id}/archive": {
        ...
        get?: never;
        put?: never;
        post: operations["ArchiveHousehold"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/households/{id}/restore": {
        ...
        get?: never;
        put?: never;
        post: operations["RestoreHousehold"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/recurring/{id}": {
        ...
        put?: never;
        post?: never;
        delete: operations["DeleteRecurringTemplate"];
        options?: never;
        head?: never;
...
export interface components {
    schemas: {
        ...
        RemovalPreviewDto: {
            ...
            viewerOpenDebts: components["schemas"]["PersonBalanceDto"][];
            /** Format: int64 */
            householdOpenTotalMinor: number | string;
        };
...
export interface operations {
    ...
    CreateContactInvite: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateContactInviteRequest"];
            };
        };
        responses: {
            /** @description Created */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["ContactInviteResultDto"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    InviteContactToHousehold: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["InviteContactRequest"];
            };
        };
        responses: {
            /** @description Created */
    ...
    GetInvitableContacts: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["InvitableContactDto"][];
                };
            };
            /** @description Forbidden */
            403: {
    ...
    GetHouseholdRemovalPreview: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RemovalPreviewDto"];
                };
            };
            /** @description Not Found */
            404: {
    ...
    LeaveHousehold: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["LeaveResultDto"];
                };
            };
            /** @description Not Found */
            404: {
